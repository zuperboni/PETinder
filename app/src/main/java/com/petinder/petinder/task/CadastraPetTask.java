...
public class CadastraPetTask extends AsyncTask {
    ...
    private final String methodEdit = "edita_pet-json";
    private final String methodBusca = "busca_pet-json";

    public CadastraPetTask(CadastroPetActivity activity, Pet pet, Bitmap imagemPerfilPet){
        this.activity = activity;
        this.pet = pet;
        this.imagemPerfilPet = imagemPerfilPet;
    }

    public CadastraPetTask(CadastroPetActivity activity, Pet pet, Boolean editar) {
        this.activity = activity;
        this.pet = pet;
        this.editar = editar;
    }
    ...
    protected Object doInBackground(Object[] objects) {
        ...
        if (!editar) {
            ...
            String data = gson.toJson(pet);
            answer = HttpConnection.getSetDataWeb(this.url, this.methodBusca, data);
